  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 lg:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 my-0 py-0 lg:px-9 border-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-6">
            ...
            <Card className="border-2 border-gray-200 hover:border-[#625BF6] hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              <CardContent className="p-4 lg:p-6">
                <div className="mb-4">
                  <h3 className="text-lg lg:text-xl font-bold text-gray-900 mb-2">Starter</h3>
                  <div className="text-xl lg:text-2xl font-bold text-gray-900 mb-1">Gratis</div>
                  <p className="text-xs lg:text-sm text-gray-600">(Para siempre)</p>
                </div>

                <div className="mb-4">
                  <h4 className="font-semibold text-gray-900 mb-2 text-xs lg:text-sm">Documentos incluidos</h4>
                  <p className="text-xs text-gray-600">
                    • Acceso a toda la{" "}
                    <button
                      onClick={() => {
                        const librarySection = document.getElementById("libreria")
                        if (librarySection) {
                          librarySection.scrollIntoView({ behavior: "smooth" })
                        }
                      }}
                      className="text-[#625BF6] hover:text-[#5048E5] underline font-medium transition-colors"
                    >
                      Librería
                    </button>{" "}
                    Normativa
                ...
                <div className="mb-4">
                  <h4 className="font-semibold text-gray-900 mb-1 text-xs lg:text-sm">Consultas/mes</h4>
                  <p className="text-lg font-bold text-[#625BF6]">15</p>
                </div>

                <div className="mb-6">
                  <h4 className="font-semibold text-gray-900 mb-1 text-xs lg:text-sm">Servicios adicionales</h4>
                  <p className="text-xs text-gray-600">—</p>
                </div>

                <Button
                  className="w-full bg-[#625BF6] hover:bg-[#5048E5] text-white font-medium transition-colors text-sm"
                  onClick={() => window.open("/register?plan=starter", "_blank")}
                >
                  Comienza gratis
                </Button>
              </CardContent>
            ...
            <Card className="border-2 border-gray-200 hover:border-[#625BF6] hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              <CardContent className="p-4 lg:p-6">
                <div className="mb-4">
                  <h3 className="text-lg lg:text-xl font-bold text-gray-900 mb-2">Basics</h3>
                  <div className="text-xs lg:text-sm text-gray-400 line-through">$9.990 CLP/mes</div>
                  <div className="text-xl lg:text-2xl font-bold text-gray-900 mb-1">$5.990 CLP/mes</div>
                  <p className="text-xs lg:text-sm text-gray-600">(antes $9.990)</p>
                </div>
                ...
                <div className="mb-6">
                  <h4 className="font-semibold text-gray-900 mb-1 text-xs lg:text-sm">Servicios adicionales</h4>
                  <p className="text-xs text-gray-600">• Soporte por correo electrónico</p>
                </div>

                <div className="space-y-2">
                  <Button
                    className="w-full bg-[#625BF6] hover:bg-[#5048E5] text-white font-medium transition-colors text-sm"
                    onClick={() => window.open("/register?plan=basics", "_blank")}
                  >
                    Comprar
                  </Button>
                  <Button
                    ...
                    onClick={() => window.open("/register?plan=basics&trial=true", "_blank")}
                  >
            ...
            <Card className="border-2 border-[#625BF6] bg-gradient-to-br from-[#625BF6]/5 to-[#625BF6]/10 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 relative">
              ...
              <CardContent className="p-4 lg:p-6">
                <div className="mb-4">
                  <h3 className="text-lg lg:text-xl font-bold text-gray-900 mb-2">Pro</h3>
                  <div className="text-xs lg:text-sm text-gray-400 line-through">$24.990 CLP/mes</div>
                  <div className="text-xl lg:text-2xl font-bold text-gray-900 mb-1">$14.990 CLP/mes</div>
                  <p className="text-xs lg:text-sm text-gray-600">(antes $24.990)</p>
                </div>

                <div className="mb-4">
                  <h4 className="font-semibold text-gray-900 mb-2 text-xs lg:text-sm">Documentos incluidos</h4>
                  <p className="text-xs text-gray-600">• Mismo catálogo que Starter y Basics</p>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="text-xs text-gray-600 space-y-1">
                    <p>• Soporte prioritario por chat (respuesta prioritaria {"<"} 24 h).</p>
                    <p>• Solicitud de incorporación de nuevos documentos a la Librería.</p>
                    <p>• Acceso anticipado a nuevas funciones y betas (opt-in).</p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <Button
                    className="w-full bg-[#625BF6] hover:bg-[#5048E5] text-white font-medium transition-colors text-sm"
                    onClick={() => window.open("/register?plan=pro", "_blank")}
                  >
                    Comprar
                  </Button>
                  <Button
                    variant="outline"
                    className="w-full border-[#625BF6] text-[#625BF6] hover:bg-[#625BF6] hover:text-white text-sm bg-transparent"
                    onClick={() => window.open("/register?plan=pro&trial=true", "_blank")}
                  >
                    Prueba 14 días gratis
                  </Button>
                </div>
            ...
            <Card className="border-2 border-gray-200 hover:border-[#625BF6] hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              <CardContent className="p-4 lg:p-6">
                <div className="mb-4">
                  <h3 className="text-lg lg:text-xl font-bold text-gray-900 mb-2">Educacional</h3>
                  <div className="text-xl lg:text-2xl font-bold text-green-600 mb-1">Gratis</div>
                </div>

                <div className="mb-4">
                  <h4 className="font-semibold text-gray-900 mb-2 text-xs lg:text-sm">Documentos incluidos</h4>
                  <p className="text-xs text-gray-600">• Mismo catálogo que Pro</p>
                </div>
                ...
                <div className="mb-6">
                  <h4 className="font-semibold text-gray-900 mb-1 text-xs lg:text-sm">Servicios adicionales</h4>
                  <div className="text-xs text-gray-600 space-y-1">
                    <p>• Licencia renovable hasta terminar tus estudios</p>
                    <p>• Registro con e-mail académico (estudiantes y docentes)</p>
                  </div>
                </div>

                <Button
                  className="w-full bg-green-600 hover:bg-green-700 text-white font-medium transition-colors text-sm"
                  onClick={() => window.open("/register?plan=educacional", "_blank")}
                >
                  Regístrate gratis
                </Button>
              </CardContent>
            ...
            <Card className="border-2 border-gray-200 hover:border-[#625BF6] hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              <CardContent className="p-4 lg:p-6">
                <div className="mb-4">
                  <h3 className="text-lg lg:text-xl font-bold text-gray-900 mb-2">Custom</h3>
                  <div className="text-xl lg:text-2xl font-bold text-gray-900 mb-1">A convenir</div>
                </div>

                <div className="mb-4">
                  <h4 className="font-semibold text-gray-900 mb-2 text-xs lg:text-sm">Documentos incluidos</h4>
                  <p className="text-xs text-gray-600">• Todo lo de Pro</p>
                </div>
                ...
                <div className="mb-6">
                  <h4 className="font-semibold text-gray-900 mb-1 text-xs lg:text-sm">Servicios adicionales</h4>
                  <div className="text-xs text-gray-600 space-y-1">
                    <p>• API y workflows a medida</p>
                    <p>• Integración en tu aplicación, sitio web o intranet</p>
                    <p>• Soporte 24/7</p>
                    <p>• Licencias en volumen para instituciones o empresas</p>
                  </div>
                </div>
